            ...
            <div className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
              <div className="text-center">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-green-600">{t("readme")}</span>
                </h1>
                <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">{t("description")}</p>
              </div>
              <div className="flex justify-center mt-6">
                <span className="inline-flex rounded-md shadow">
                  <Link href="/editor" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-lg text-gray-600 bg-white hover:text-green-500">{t("get-started")}</Link>
                </span>
              </div>
              <div className="text-center">
                <p className="mt-3 mx-auto text-sm text-gray-900">{t("100-free")}</p>
              </div>
            </div>
          </div>
        </div>
